...
const bcrypt = require('bcryptjs'); // Needed for both hashing and comparing
...
router.post('/register', async (req, res) => {
    ...
    try {
        ...
        // NEW: Explicitly hash the password here before saving
...
router.post('/login', async (req, res) => {
    ...
    try {
        ...
        // Call the comparePassword method on the retrieved user document
